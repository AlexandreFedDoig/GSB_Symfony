 ...
 */
final class Version20190328094022 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE switchboard items');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE switchboard items (SwitchboardID INT NOT NULL, ItemNumber INT DEFAULT 0 NOT NULL, ItemText VARCHAR(255) DEFAULT NULL COLLATE utf8_general_ci, Command INT DEFAULT NULL, Argument VARCHAR(255) DEFAULT NULL COLLATE utf8_general_ci, PRIMARY KEY(SwitchboardID, ItemNumber)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = MyISAM COMMENT = \'\' ');
