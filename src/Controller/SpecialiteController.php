...
class SpecialiteController extends AbstractController
{
    ...
    /**
     * @Route("/{speCode}", name="specialite_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{speCode}/edit", name="specialite_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{speCode}", name="specialite_delete", methods={"DELETE"})
     */
    public function delete(Request $request, Specialite $specialite): Response
    {
        if ($this->isCsrfTokenValid('delete'.$specialite->getSpeCode(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
