...
class MedicamentController extends AbstractController
{
    ...
    /**
     * @Route("/{medDepotlegal}", name="medicament_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{medDepotlegal}/edit", name="medicament_edit", methods={"GET","POST"})
     */
    public function edit(Request $request, Medicament $medicament): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('medicament_index', [
                'medDepotlegal' => $medicament->getMedDepotlegal(),
            ]);
        }
    ...
    /**
     * @Route("/{medDepotlegal}", name="medicament_delete", methods={"DELETE"})
     */
    public function delete(Request $request, Medicament $medicament): Response
    {
        if ($this->isCsrfTokenValid('delete'.$medicament->getMedDepotlegal(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
